...
public class HighScore extends javax.swing.JFrame {
    ...
    public Vector<Vector> initData() {
        Vector<UserRecord> data = QuizAppConnection.getRecord();
        ...
        for (UserRecord record : data) {
            ...
            v.add(record.getFullname());
            v.add(record.getRow());
            v.add(record.getCol());
            int time =  record.getTime();
            v.add(String.format("%02d:%02d", time / 60, time % 60));
            vector.add(v);
        }
        return vector;
    }
    ...
    public void loadDataToTable() {
        ...
        model.setDataVector(initData(), header);
    }
